...
partial class Client {
    ...
    /// </summary>
    /// <param name="statusId"></param>
    /// <returns>Returns a PreviewCard</returns>
    public Task<PreviewCard> GetStatusCard(string statusId) {
        return Get<PreviewCard>($"/api/v1/statuses/{statusId}/card");
    }
    ...
    public Task<Status> PublishStatus(string status, StatusVisibility? visibility = null, string? replyStatusId = null,
