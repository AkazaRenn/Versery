...
public interface IStatuses {
    ...
    Task<Status> Edit(
        ...
        [AliasAs("language")] CultureInfo? language = null,
        [AliasAs("media_ids[]")][Query(CollectionFormat.Multi)] IEnumerable<string>? mediaIds = null,
        [AliasAs("media_attributes[][id]")][Query(CollectionFormat.Multi)] IEnumerable<string>? mediaAttributesId = null,
        [AliasAs("media_attributes[][description]")][Query(CollectionFormat.Multi)] IEnumerable<string>? mediaAttributesDescription = null,
        [AliasAs("media_attributes[][focus]")][Query(CollectionFormat.Multi)] IEnumerable<string>? mediaAttributesFocus = null,
        [AliasAs("poll[options][]")][Query(CollectionFormat.Multi)] IEnumerable<string>? pollOptions = null,
